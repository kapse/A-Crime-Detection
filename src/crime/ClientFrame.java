...
public class ClientFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/reg3.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/chk1.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ApplyFrame af = null;
            boolean AlreadyLoaded = isLoaded("Apply");
            System.out.println(AlreadyLoaded);
            if (AlreadyLoaded == false) {
                af = new ApplyFrame(this);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            Dimension screen = Toolkit.getDefaultToolkit().getScreenSize();
            AppStatusFrame af = null;
            boolean AlreadyLoaded = isLoaded("Status");
            System.out.println(AlreadyLoaded);
            if (AlreadyLoaded == false) {
                af = new AppStatusFrame(this);
                jDesktopPane1.add(af);
                af.setVisible(true);
                af.show();
